...
RSpec.describe Outhad::Integrations::Config do
  describe "#initialize" do
    context "without parameters" do
      it "initializes without errors" do
        expect { Outhad::Integrations::Config.new }.not_to raise_error
      end

      it "has a nil logger by default" do
        config = Outhad::Integrations::Config.new
    ...
    context "with a logger parameter" do
      ...
      it "accepts a logger parameter" do
        config = Outhad::Integrations::Config.new(logger: logger)
  ...
  describe "logger attribute" do
    let(:config) { Outhad::Integrations::Config.new }
