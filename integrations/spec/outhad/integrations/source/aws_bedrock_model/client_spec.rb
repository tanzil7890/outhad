...
RSpec.describe Outhad::Integrations::Source::AwsBedrockModel::Client do
  let(:client) { Outhad::Integrations::Source::AwsBedrockModel::Client.new }
  let(:payload) do
    {
      prompt: "\n\nHuman: Hi\n\nAssistant:",
  ...
  describe "#check_connection" do
    ...
    context "when the connection fails" do
      it "returns a failed connection status with an error message" do
        allow_any_instance_of(Outhad::Integrations::Source::AwsBedrockModel::Client).to receive(:create_connection).and_raise(StandardError, "Connection failed")
        message = client.check_connection(sync_config[:source][:connection_specification])
        result = message.connection_status
