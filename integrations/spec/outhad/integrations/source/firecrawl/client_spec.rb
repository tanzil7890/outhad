...
RSpec.describe Outhad::Integrations::Source::Firecrawl::Client do
  let(:client) { Outhad::Integrations::Source::Firecrawl::Client.new }
  ...
  describe "#discover" do
    before do
      response = instance_double(Net::HTTPSuccess, code: "200", body:
      {
        ...
        "data" =>
          {
            "markdown" => "[AI Outhad home page](https://docs.outhad.ai)",
            "metadata" => {
              "title" => "Welcome - AI Outhad",
