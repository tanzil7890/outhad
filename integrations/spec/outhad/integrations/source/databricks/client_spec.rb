...
RSpec.describe Outhad::Integrations::Source::Databricks::Client do
  let(:client) { Outhad::Integrations::Source::Databricks::Client.new }
  ...
  describe "#read" do
    it "reads records successfully" do
      ...
      outhad_message = records.first
      first_record = outhad_message.record
      expect(first_record).to be_a(Outhad::Integrations::Protocol::RecordMessage)
