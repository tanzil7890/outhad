...
RSpec.describe Outhad::Integrations::Source::Bigquery::Client do
  let(:client) { Outhad::Integrations::Source::Bigquery::Client.new }
  let(:sync_config) do
    {
      "source": {
  ...
  describe "#read" do
    it "reads records successfully" do
      ...
      expect(records[1]).to be_a(Outhad::Integrations::Protocol::OuthadMessage)
