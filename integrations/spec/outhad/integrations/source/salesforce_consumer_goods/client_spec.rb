...
RSpec.describe Outhad::Integrations::Source::SalesforceConsumerGoodsCloud::Client do
  include WebMock::API
  ...
  describe "#read" do
    context "when read is successful" do
      it "returns an array of OuthadMessages with RecordMessages" do
        ...
        expect(results).to all(be_a(Outhad::Integrations::Protocol::OuthadMessage))
  ...
  describe "#meta_data" do
    it "serves it github image url as icon" do
      image_url = "https://raw.githubusercontent.com/Outhad/outhad/main/integrations/lib/outhad/integrations/source/salesforce_consumer_goods_cloud/icon.svg"
  ...
  describe "#discover" do
    context "when discovery is successful" do
      it "returns a OuthadMessage with the expected catalog structure" do
