...
RSpec.describe Outhad::Integrations::Source::DatabricksModel::Client do
  include WebMock::API
  ...
  describe "#check_connection" do
    context "when the connection is successful" do
      ...
      it "returns a succeeded connection status" do
        ...
        expect(result).to be_a(Outhad::Integrations::Protocol::ConnectionStatus)
  ...
  describe "#read" do
    ...
    context "when the payload is invalid in read" do
      ...
      it "handles exceptions during reading" do
        records = client.read(sync_config)
        expect(records.log).to be_a(Outhad::Integrations::Protocol::LogMessage)
