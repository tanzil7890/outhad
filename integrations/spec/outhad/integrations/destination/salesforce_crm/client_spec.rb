...
RSpec.describe Outhad::Integrations::Destination::SalesforceCrm::Client do
  include WebMock::API
  ...
  describe "#meta_data" do
    it "serves it github image url as icon" do
      image_url = "https://raw.githubusercontent.com/Outhad/outhad/main/integrations/lib/outhad/integrations/destination/salesforce_crm/icon.svg"
