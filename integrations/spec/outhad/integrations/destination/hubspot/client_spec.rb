...
RSpec.describe Outhad::Integrations::Destination::Hubspot::Client do
  include WebMock::API
  ...
  let(:records) do
    [
      build_record("developer@outhad.com"),
      build_record("developer_second@outhad.com")
    ]
  end
  ...
  describe "#write" do
    context "when the write operation is successful" do
      before do
        stub_create_request("developer@outhad.com", 200)
        stub_create_request("developer_second@outhad.com", 200)
      end
    ...
    context "when the write operation fails" do
      before do
        stub_create_request("developer@outhad.com", 403)
        stub_create_request("developer_second@outhad.com", 403)
      end
  ...
  describe "#meta_data" do
    it "serves it github image url as icon" do
      image_url = "https://raw.githubusercontent.com/Outhad/outhad/main/integrations/lib/outhad/integrations/destination/hubspot/icon.svg"
