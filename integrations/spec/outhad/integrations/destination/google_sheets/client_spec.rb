...
RSpec.describe Outhad::Integrations::Destination::GoogleSheets::Client do
  include WebMock::API
  ...
  let(:connection_config) do
    {
      ...
      "credentials_json": {
        ...
        "client_email": "outhad@outhad.iam.gserviceaccount.com",
        "client_id": "client_id",
  ...
  describe "#meta_data" do
    it "serves it github image url as icon" do
      image_url = "https://raw.githubusercontent.com/Outhad/outhad/main/integrations/lib/outhad/integrations/destination/google_sheets/icon.svg"
