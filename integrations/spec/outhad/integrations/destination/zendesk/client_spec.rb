...
RSpec.describe Outhad::Integrations::Destination::Zendesk::Client do
  include WebMock::API
  ...
  let(:source_connector) do
    {
      ...
      type: Outhad::Integrations::Protocol::ConnectorType["source"],
  ...
  let(:destination_connector) do
    {
      ...
      type: Outhad::Integrations::Protocol::ConnectorType["destination"],
  ...
  let(:model) do
    {
      ...
      query_type: Outhad::Integrations::Protocol::ModelQueryType["raw_sql"],
      primary_key: "id"
    }
  end
  ...
  let(:sync_config) do
    Outhad::Integrations::Protocol::SyncConfig.new(
      source: source_connector,
      destination: destination_connector,
      model: model,
      stream: stream,
      sync_mode: Outhad::Integrations::Protocol::SyncMode["incremental"],
      destination_sync_mode: Outhad::Integrations::Protocol::DestinationSyncMode["insert"]
    )
  end
