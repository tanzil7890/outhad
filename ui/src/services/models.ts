...
export const createNewModel = async (payload: CreateModelPayload) =>
  outhadFetch<CreateModelPayload, ApiResponse<CreateModelResponse>>({
    method: 'post',
    url: '/models',
    data: payload,
  });
...
export const getModelById = async (id: string): Promise<ModelAPIResponse<GetModelByIdResponse>> =>
  outhadFetch<string, ModelAPIResponse<GetModelByIdResponse>>({
    method: 'get',
    url: '/models/' + id,
  });
...
export const putModelById = async (
  ...
  outhadFetch<UpdateModelPayload, ApiResponse<GetModelByIdResponse>>({
    method: 'put',
    url: '/models/' + id,
    data: payload,
  });
