...
require_relative '../app/middleware/outhad_server/quiet_logger'
require_relative '../app/middleware/outhad_server/request_response_logger'
...
module OuthadServer
  class Application < Rails::Application
    ...
    config.middleware.insert_before Rails::Rack::Logger, OuthadServer::QuietLogger
    config.middleware.use OuthadServer::RequestResponseLogger
