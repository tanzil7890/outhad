...
module ModelContracts
  ...
  class Create < Dry::Validation::Contract
    ...
    rule(model: :query_type) do
      key.failure("invalid query type") unless Outhad::Integrations::Protocol::ModelQueryType.include?(value)
    end
  ...
  class Update < Dry::Validation::Contract
    ...
    rule(model: :query_type) do
      unless !key? || Outhad::Integrations::Protocol::ModelQueryType.include?(value)
