...
RSpec.describe ReverseEtl::Extractors::IncrementalDelta do
  ...
  let(:client) { Outhad::Integrations::Source::Snowflake::Client.new }
  let(:record1) do
  ...
  let(:record2) do
    Outhad::Integrations::Protocol::RecordMessage.new(data: { "id" => 2, "email" => "test2@mail.com",
  ...
  describe "#read" do
    ...
    context "when an existing record is updated" do
      it "updates the existing sync record with fingerprint change" do
        ...
        modified_record1 = Outhad::Integrations::Protocol::RecordMessage.new(
    ...
    describe "#update_or_create_sync_record" do
      let(:record) do
        Outhad::Integrations::Protocol::RecordMessage.new(data: { "id" => 1, "email" => "test1@mail.com",
                                                                      "first_name" => "John", "Last Name" => "Doe" },
                                                              emitted_at:
                                                              DateTime.now.to_i).to_outhad_message
      end
      let(:record_dup) do
        Outhad::Integrations::Protocol::RecordMessage.new(data: { "id" => 1, "email" => "test1@mail.com",
                                                                      "first_name" => "John", "Last Name" => "Doe" },
