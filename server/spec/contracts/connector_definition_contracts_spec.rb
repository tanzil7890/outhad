...
RSpec.describe "ConnectorDefinitionContracts" do
  before do
    stub_const("Outhad::Integrations::Protocol::ConnectorType",
               { "source" => "source", "destination" => "destination" })
    stub_const("Outhad::Integrations::ENABLED_SOURCES", ["valid_source"])
    stub_const("Outhad::Integrations::ENABLED_DESTINATIONS", ["valid_destination"])
  end
